...
class RegisterController extends Controller
{
    ...
    */
     ...
     * @param  array  $data an array converted from FormData object, which is gotten from registration form
     * @return \App\User an User intance which will be save to Database
     */
